...
void test_eco(void) {
    ...
    assert(scid_eco_code_to_string(
               code, SCID_ECO_FORMAT_BASIC, text, sizeof(text), &text_size) == SCID_OK);
    assert(strcmp(text, "B91") == 0);
    assert(text_size == 3);
    assert(scid_eco_code_to_string(
               code, SCID_ECO_FORMAT_EXTENDED, text, sizeof(text), &text_size) == SCID_OK);
    ...
    assert(code == SCID_ECO_NONE);
    assert(scid_eco_code_to_string(
               SCID_ECO_NONE, SCID_ECO_FORMAT_EXTENDED, text, sizeof(text), &text_size) ==
           SCID_OK);
    ...
    assert(scid_eco_code_to_string(
               code, (scid_eco_format)99, text, sizeof(text), &text_size) ==
           SCID_ERROR_BAD_ARG);
    assert(scid_eco_code_to_string(
    ...
    assert(scid_eco_book_name_find(NULL, position, text, sizeof(text), &text_size) ==
           SCID_ERROR_BAD_ARG);
    assert(scid_eco_book_name_find(book, NULL, text, sizeof(text), &text_size) ==
           SCID_ERROR_BAD_ARG);
    assert(scid_eco_book_name_find(book, position, text, sizeof(text), NULL) ==
           SCID_ERROR_BAD_ARG);
