...
namespace
{
    ...
    TEST(
        CoreNotationTest,
        WritesCurrentPositionUciFromMainlineCursor)
    {
        scid::core::Game game;
    ...
    TEST(
        CoreNotationTest,
        WritesPreviousAndNextMoveUciAtCursor)
    {
        scid::core::Game game;
        game.appendMainlineMove(quiet(scid::core::D2, scid::core::D4));
        game.appendMainlineMove(quiet(scid::core::D7, scid::core::D5));
        ...
        EXPECT_EQ("d2d4", scid::core::notation::previousMoveUci(game, cursor.location()));
        EXPECT_EQ("d7d5", scid::core::notation::nextMoveUci(game, cursor.location()));
    }

    TEST(
        CoreNotationTest,
        WritesEmptyPreviousAndNextMoveUciAtBoundaries)
    {
        scid::core::Game game;
        game.appendMainlineMove(quiet(scid::core::D2, scid::core::D4));
        scid::core::GameCursor cursor(game);

        EXPECT_EQ("", scid::core::notation::previousMoveUci(game, cursor.location()));
        EXPECT_EQ("d2d4", scid::core::notation::nextMoveUci(game, cursor.location()));
    ...
    TEST(
        CoreNotationTest,
        WritesNextAndPreviousSanAtCursor)
    {
        scid::core::Game game;
        game.appendMainlineMove(quiet(scid::core::D2, scid::core::D4));
        game.appendMainlineMove(quiet(scid::core::D7, scid::core::D5));
        ...
        EXPECT_EQ("d4", scid::core::notation::previousSan(game, cursor.location()));
        EXPECT_EQ("d5", scid::core::notation::nextSan(game, cursor.location()));
    }

    TEST(
        CoreNotationTest,
        WritesEmptyPreviousAndNextSanAtBoundaries)
    {
        scid::core::Game game;
        game.appendMainlineMove(quiet(scid::core::D2, scid::core::D4));
        scid::core::GameCursor cursor(game);
        ...
        PrefersStoredSanWhenPresent)
    {
        ...
        ASSERT_TRUE(cursor.next());
        EXPECT_EQ("SAN", scid::core::notation::previousSan(game, cursor.location()));
    }

    TEST(
        CoreNotationTest,
        ReturnsEmptySanForIllegalAction)
    {
        scid::core::Game game;
    ...
    TEST(
        CoreNotationTest,
        WritesPartialMoveListFromMainlineStart)
    {
        scid::core::Game game;
        game.appendMainlineMove(quiet(scid::core::D2, scid::core::D4));
        game.appendMainlineMove(quiet(scid::core::D7, scid::core::D5));
        ...
        EXPECT_EQ("1. d4 d5 2. c4", scid::core::notation::partialMoveList(game, 3));
    }

    TEST(
        CoreNotationTest,
        WritesPartialMoveListWithInitialBlackMoveNumber)
    {
        scid::core::Game game;
        ASSERT_EQ(scid::core::OK, game.setStartFen("8/8/8/8/2p5/1k1p4/p4N2/2K5 b - - 0 198"));
        game.appendMainlineMove({scid::core::A2, scid::core::A1, scid::core::QUEEN});

        EXPECT_EQ("198... a1=Q+", scid::core::notation::partialMoveList(game, 1));
    }
    ...
    TEST(
        CoreNotationTest,
        WritesCurrentPositionUciFromNonStandardStart)
    {
        scid::core::Game game;
        ASSERT_EQ(scid::core::OK, game.setStartFen("8/8/8/8/2p5/1k1p4/p4N2/2K5 w - - 0 198"));
    ...
    TEST(
        CoreNotationTest,
        ResetsCurrentPositionUciAtNullMove)
    {
        scid::core::Game game;
