...
namespace
{
    ...
    const std::string test_pgnShort = "1. d4 d5 2. c4 ( 2. Nf3 Nf6 ( 2... Bg4 ) 3. c3 ) "
                                      "( 2. g3 Nf6 3. Bg2 ( 3. Nf3 ) )";

    std::vector<scid::core::gamepos::GamePos>
    expectedGamePositions()
    {
        return {
            makeGamePos(0, 0, "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1", ""),
            makeGamePos(0, 0, "rnbqkbnr/pppppppp/8/8/3P4/8/PPP1PPPP/RNBQKBNR b KQkq - 0 1", "d4"),
            makeGamePos(0, 0, "rnbqkbnr/ppp1pppp/8/3p4/3P4/8/PPP1PPPP/RNBQKBNR w KQkq - 0 2", "d5"),
            makeGamePos(0, 0, "rnbqkbnr/ppp1pppp/8/3p4/2PP4/8/PP2PPPP/RNBQKBNR b KQkq - 0 2", "c4"),
            makeGamePos(
    ...
    parseShortGame()
    {
        ...
        EXPECT_TRUE(
            scid::core::pgn::parseGame(
                test_pgnShort.c_str(), test_pgnShort.size(), game, parseLog));
...
TEST(
    CoreGamePositionsTest,
    CollectsFenAndRavMetadata)
{
...
TEST(
    CoreGamePositionsTest,
    PreservesEnoughDataToReconstructMovetext)
{
    auto game = parseShortGame();
