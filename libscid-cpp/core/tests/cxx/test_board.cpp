...
namespace
{
    ...
    TEST(
        BoardTest,
        DefinesMinorPieceAndSliderHelpers)
    {
        EXPECT_EQ(16, WM);
        EXPECT_EQ(17, BM);
    ...
    TEST(
        BoardTest,
        ComputesSquareColoursDiagonalsAndFlips)
    {
    ...
    TEST(
        BoardTest,
        ComputesSquareDistanceAndEdges)
    {
    ...
    TEST(
        BoardTest,
        DefinesStartingBoardAndSquareColours)
    {
