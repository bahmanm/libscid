...
TEST(
    Test_PrintFen,
    castling_flag_kside_from_pgn)
{
    std::string_view pgn = "[FEN \"Brbnk1r1/3pppq1/8/ppp3pp/PPP3PP/8/3PPPQ1/bRBNK1R1 w KQkq - "
                           "0 1\"]"
...
TEST(
    Test_PrintFen,
    castling_flag_qside_from_pgn)
{
    std::string_view pgn = "[FEN \"Br2k1r1/1b1ppn2/8/pppQ1pPp/PPPq1PP1/8/1B1PPN2/bR2K1R1 b "
                           "KQkq - 0 1\"]"
