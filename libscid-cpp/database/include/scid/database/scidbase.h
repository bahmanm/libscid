...
namespace scid::database
{
    ...
    struct scidBaseT
    {
            ...
            struct Stats
            {
                     ...
                     */
                    const Eco*
                    getEcoStats(const char* ecoStr) const;
             ...
             */
            void
            deleteFilter(const char* filterId);
            /**
             ...
             */
            std::vector<TreeNode>
            getTreeStat(const HFilter& filter) const;
            /**
             ...
             */
            scid::core::errorT
            compact(const Progress& progress);
             ...
             */
            bool
            createSortCache(const char* criteria);
             ...
             */
            void
            releaseSortCache(const char* criteria);
        ...
        private:
            ...
            static GameInfo
            makeGameInfo_(const IndexEntry& ie);
            ByteBuffer
            gameData(const IndexEntry& ie) const;
            GameView
            gameView(const IndexEntry* ie) const;
            scid::core::errorT
            openHelper(
                std::string_view dbType,
                fileModeT mode,
        ...
        TRatingResolver ratingFor)
    {
        ...
        auto entry_op = [&](IndexEntry& ie) {
            ...
            const auto blackElo =
                (!overwrite && ie.GetBlackElo() != 0) ? 0 : ratingFor(ie.GetBlack(), date);
