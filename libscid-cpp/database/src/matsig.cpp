...
namespace scid::database
{
        ...
        matSigT m)
    {
        ...
        s.reserve(32);
        scid::core::uint i;
        for (i = 0; i < MATSIG_Count_WQ(m); i++)
        {
            s += 'Q';
        }
        for (i = 0; i < MATSIG_Count_WR(m); i++)
        {
            s += 'R';
        }
        for (i = 0; i < MATSIG_Count_WB(m); i++)
        {
            s += 'B';
        }
        for (i = 0; i < MATSIG_Count_WN(m); i++)
        {
            s += 'N';
        }
        ...
        if (wp > 0)
            s += (wp + '0');
        s += ':';
        for (i = 0; i < MATSIG_Count_BQ(m); i++)
        {
            s += 'Q';
        }
        for (i = 0; i < MATSIG_Count_BR(m); i++)
        {
            s += 'R';
        }
        for (i = 0; i < MATSIG_Count_BB(m); i++)
        {
            s += 'B';
        }
        for (i = 0; i < MATSIG_Count_BN(m); i++)
        {
            s += 'N';
        }
        ...
        bool upromo)
    {
        ...
        if (MATSIG_Count_BP(mStart) < MATSIG_Count_BP(mTarget))
        {
            return false;
        }
        ...
        if (MATSIG_Count_WR(mStart) < MATSIG_Count_WR(mTarget))
        {
            return false;
        }
        if (MATSIG_Count_BR(mStart) < MATSIG_Count_BR(mTarget))
        {
            return false;
        }
        if (MATSIG_Count_WB(mStart) < MATSIG_Count_WB(mTarget))
        {
            return false;
        }
        if (MATSIG_Count_BB(mStart) < MATSIG_Count_BB(mTarget))
        {
            return false;
        }
        if (MATSIG_Count_WN(mStart) < MATSIG_Count_WN(mTarget))
        {
            return false;
        }
        if (MATSIG_Count_BN(mStart) < MATSIG_Count_BN(mTarget))
        {
            return false;
        }
        ...
        // Check queen counts:
        if (MATSIG_Count_WQ(mStart) < MATSIG_Count_WQ(mTarget))
        {
            return false;
        }
        if (MATSIG_Count_BQ(mStart) < MATSIG_Count_BQ(mTarget))
        {
            return false;
        }
