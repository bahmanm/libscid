...
```sh
cmake -S examples/libscid-cpp/040-open-database -B _build/examples/libscid-cpp/040-open-database -DCMAKE_PREFIX_PATH=install/libscid
cmake --build _build/examples/libscid-cpp/040-open-database
ctest --test-dir _build/examples/libscid-cpp/040-open-database --output-on-failure
```
