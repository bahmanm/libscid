...
main()
{
    ...
    if (db.open("MEMORY", scid::database::FMODE_Create, "Imported PGN") != scid::core::OK)
    {
    ...
    const auto import_err =
        db.importGames("PGN", LIBSCID_EXAMPLE_PGN_FILE, scid::database::Progress(), import_errors);
    ...
    if (db.loadGame(0, game, scid_flags.data(), scid_flags.size()) != scid::core::OK)
    {
        return 1;
    }
