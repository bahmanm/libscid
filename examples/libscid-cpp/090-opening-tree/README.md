...
```sh
cmake -S examples/libscid-cpp/090-opening-tree -B _build/examples/libscid-cpp/090-opening-tree -DCMAKE_PREFIX_PATH=install/libscid
cmake --build _build/examples/libscid-cpp/090-opening-tree
ctest --test-dir _build/examples/libscid-cpp/090-opening-tree --output-on-failure
```
