...
```sh
cmake -S examples/libscid/140-search-position -B _build/examples/libscid/140-search-position -DCMAKE_PREFIX_PATH=install/libscid
cmake --build _build/examples/libscid/140-search-position
ctest --test-dir _build/examples/libscid/140-search-position --output-on-failure
```
