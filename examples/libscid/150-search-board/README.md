...
```sh
cmake -S examples/libscid/150-search-board -B _build/examples/libscid/150-search-board -DCMAKE_PREFIX_PATH=install/libscid
cmake --build _build/examples/libscid/150-search-board
ctest --test-dir _build/examples/libscid/150-search-board --output-on-failure
```
