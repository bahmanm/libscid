...
- `040-navigate-pgn/`: navigate mainline moves and variations with a game cursor.
- `050-position-and-moves/`: apply moves to a position and inspect the resulting state.
- `060-mutate-pgn/`: edit move metadata and merge source moves into an existing PGN game.
