...
```sh
cmake -S examples/libscid/090-list-database -B _build/examples/libscid/090-list-database -DCMAKE_PREFIX_PATH=install/libscid
cmake --build _build/examples/libscid/090-list-database
ctest --test-dir _build/examples/libscid/090-list-database --output-on-failure
```
