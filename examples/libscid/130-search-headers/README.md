...
```sh
cmake -S examples/libscid/130-search-headers -B _build/examples/libscid/130-search-headers -DCMAKE_PREFIX_PATH=install/libscid
cmake --build _build/examples/libscid/130-search-headers
ctest --test-dir _build/examples/libscid/130-search-headers --output-on-failure
```
