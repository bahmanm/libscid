...
include( "${LIBSCID_SOURCE_ROOT}/cmake/test/runtime-dlls.cmake" )
include( "${LIBSCID_SOURCE_ROOT}/cmake/qc/sanitisers.cmake" )
...
if( PROJECT_IS_TOP_LEVEL )
    ...
    include( CTest )
    include( "${LIBSCID_SOURCE_ROOT}/cmake/qc/clang-tidy.cmake" )
    include( "${LIBSCID_SOURCE_ROOT}/cmake/qc/cppcheck.cmake" )
    include( "${LIBSCID_SOURCE_ROOT}/cmake/qc/format.cmake" )
    include( "${LIBSCID_SOURCE_ROOT}/cmake/qc/include-cleaner.cmake" )
endif()
