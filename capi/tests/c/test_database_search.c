...
static void
test_search_header_criteria_configuration(void)
{
...
static void
test_search_board_criteria_configuration(void)
{
    ...
    TEST_ASSERT(
        scid_search_board_criteria_match_set(criteria, SCID_BOARD_SEARCH_MATCH_FILES) == SCID_OK);
    TEST_ASSERT(scid_search_board_criteria_match_get(criteria, &match) == SCID_OK);
    TEST_ASSERT(match == SCID_BOARD_SEARCH_MATCH_FILES);
...
static void
test_database_search_headers_execution(void)
{
...
static void
test_database_search_position_execution(void)
{
    scid_database*              database = create_search_database();
    scid_filter_id              filter_id = 0;
    scid_filter_id              filter_id_two = 0;
...
static void
test_database_search_board_execution(void)
{
    scid_database*              database = create_search_database();
    scid_filter_id              filter_id = 0;
    scid_filter_id              filter_id_two = 0;
...
{
    test_search_header_criteria_configuration();
    test_search_board_criteria_configuration();
    test_database_search_headers_execution();
    test_database_search_position_execution();
    test_database_search_board_execution();
}
