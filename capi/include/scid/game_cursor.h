/**
 * @file game_cursor.h
 * @brief Hierarchical chess game movetext cursor, tree navigation, commentary, NAGs, and variation
 * editing.
 */
...
extern "C"
{
     ...
     * @brief Hierarchical movetext tree traversal, ply positioning, commentary, NAG annotations,
     * and variation manipulation.
     * @{
     */
     ...
     *
     * @param[in]  game          Pointer to the game entity bound to @p source_cursor. Must not be
     * NULL.
     * @param[in]  source_cursor Pointer to the cursor to clone. Must not be NULL.
     * @param[out] out_cursor    Pointer to a handle pointer receiving the newly allocated duplicate
    ...
    /**
     * @brief Retrieves the 0-based ply count from the start of the current line to this cursor
     * node.
     *
     * @param[in]  cursor  Pointer to the cursor. Must not be NULL.
    ...
    /**
     * @brief Retrieves the number of sub-variations branching from the upcoming move at this cursor
     * node.
     *
     * @param[in]  cursor    Pointer to the cursor. Must not be NULL.
    ...
    /**
     * @brief Retrieves the index of the current variation among sibling variations at the parent
     * fork.
     *
     * Returns `0` if the cursor is on the first variation (or mainline), `1` for the second
     * variation, etc.
     *
     * @param[in]  cursor    Pointer to the cursor. Must not be NULL.
     ...
     *
     * @param[in]  cursor            Pointer to the cursor. Must not be NULL.
     * @param[out] out_is_line_start Pointer receiving non-zero (`1`) if at line start; `0`
    ...
    /**
     * @brief Checks if the cursor is at the terminal end of the current line or variation (no
     * subsequent move).
     *
     * @param[in]  cursor          Pointer to the cursor. Must not be NULL.
     ...
     *
     * @param[in]  cursor            Pointer to the cursor. Must not be NULL.
     * @param[out] out_is_game_start Pointer receiving non-zero (`1`) if at game start; `0`
     * otherwise. Must not be NULL.
     *
     * @retval SCID_OK           Check completed successfully.
     ...
     *
     * @param[in]  cursor          Pointer to the cursor. Must not be NULL.
     * @param[out] out_is_game_end Pointer receiving non-zero (`1`) if at mainline end; `0`
     * otherwise. Must not be NULL.
     *
     * @retval SCID_OK           Check completed successfully.
     ...
     *
     * @param[in]  cursor                 Pointer to the cursor. Must not be NULL.
     * @param[out] out_is_variation_start Pointer receiving non-zero (`1`) if at variation start;
     ...
     *
     * @param[in]  cursor               Pointer to the cursor. Must not be NULL.
     * @param[out] out_is_variation_end Pointer receiving non-zero (`1`) if at variation end; `0`
     * otherwise. Must not be NULL.
     *
     * @retval SCID_OK           Check completed successfully.
    ...
    /**
     * @brief Checks if the current variation contains zero moves (empty branch containing only
     * comments).
     *
     * @param[in]  cursor                 Pointer to the cursor. Must not be NULL.
     * @param[out] out_is_variation_empty Pointer receiving non-zero (`1`) if variation has no
     * moves; `0` otherwise. Must not be NULL.
     *
     * @retval SCID_OK           Check completed successfully.
     ...
     * @retval SCID_ERROR_BAD_ARG If @p cursor or @p out_move is NULL, or if cursor is at line
     * start.
     *
     ...
     * @retval SCID_ERROR_BAD_ARG    If @p cursor or @p out_text_size is NULL, or if cursor is at
     * line start.
     * @retval SCID_ERROR_BUFFER_FULL If @p out_text_capacity is insufficient.
     *
     ...
     *
     * @retval SCID_OK           Count retrieved successfully.
     * @retval SCID_ERROR_BAD_ARG If @p cursor or @p out_count is NULL, or if cursor is at line
     * start.
     *
     ...
     * @retval SCID_ERROR_BAD_ARG If @p cursor or @p out_nag is NULL, or if @p index is out of
     * bounds.
     *
     ...
     * @param[out] out_start_cursor Pointer to a handle pointer receiving the newly allocated
     * cursor. Must not be NULL.
     *
     * @retval SCID_OK           Cursor created successfully.
     * @retval SCID_ERROR_BAD_ARG If @p cursor or @p out_start_cursor is NULL.
     *
     * @note The caller acquires ownership of @p out_start_cursor and must release it with @ref
     * scid_game_cursor_free().
     *
     ...
     *
     * @note The caller acquires ownership of @p out_end_cursor and must release it with @ref
     * scid_game_cursor_free().
     *
     ...
     * @param[out] out_moved      Pointer receiving non-zero (`1`) if navigation succeeded; `0` if
     * ply is out of range. Must not be NULL.
     * @param[out] out_ply_cursor Pointer to a handle pointer receiving the newly allocated cursor
     ...
     *
     * @note The caller acquires ownership of @p out_ply_cursor and must release it with @ref
     * scid_game_cursor_free().
     */
    SCID_API scid_error
     ...
     *
     * @param[in]  cursor          Pointer to the source cursor. Must not be NULL.
     * @param[out] out_moved       Pointer receiving non-zero (`1`) if advanced forward; `0` if
     * already at line end. Must not be NULL.
     * @param[out] out_next_cursor Pointer to a handle pointer receiving the newly allocated cursor
     * on success. Must not be NULL.
     *
     * @retval SCID_OK           Step completed successfully.
     * @retval SCID_ERROR_BAD_ARG If any argument is NULL.
     *
     * @note The caller acquires ownership of @p out_next_cursor and must release it with @ref
     * scid_game_cursor_free().
     *
     ...
     *
     * @param[in]  cursor              Pointer to the source cursor. Must not be NULL.
     * @param[out] out_moved           Pointer receiving non-zero (`1`) if stepped backward; `0` if
     * already at line start. Must not be NULL.
     * @param[out] out_previous_cursor Pointer to a handle pointer receiving the newly allocated
     * cursor on success. Must not be NULL.
     *
     * @retval SCID_OK           Step completed successfully.
     * @retval SCID_ERROR_BAD_ARG If any argument is NULL.
     *
     * @note The caller acquires ownership of @p out_previous_cursor and must release it with @ref
     * scid_game_cursor_free().
     *
     ...
     *
     * @param[in]  cursor               Pointer to the source cursor at the branching node. Must not
     * be NULL.
     * @param[in]  index                Zero-based index of the sub-variation to enter
     * (`0..variation_count - 1`).
     * @param[out] out_entered          Pointer receiving non-zero (`1`) if variation entered; `0`
     * if @p index is invalid. Must not be NULL.
     * @param[out] out_variation_cursor Pointer to a handle pointer receiving the newly allocated
     * cursor at the start of the sub-variation. Must not be NULL.
     *
     * @retval SCID_OK           Operation completed successfully.
     * @retval SCID_ERROR_BAD_ARG If any argument is NULL.
     *
     * @note The caller acquires ownership of @p out_variation_cursor and must release it with @ref
     * scid_game_cursor_free().
     *
     ...
     *
     * @param[in]  cursor            Pointer to the source cursor in the variation. Must not be
     * NULL.
     * @param[out] out_exited        Pointer receiving non-zero (`1`) if exited; `0` if already on
     * mainline. Must not be NULL.
     * @param[out] out_parent_cursor Pointer to a handle pointer receiving the newly allocated
     * parent cursor. Must not be NULL.
     *
     * @retval SCID_OK           Operation completed successfully.
     * @retval SCID_ERROR_BAD_ARG If any argument is NULL.
     *
     * @note The caller acquires ownership of @p out_parent_cursor and must release it with @ref
     * scid_game_cursor_free().
     *
     * @see scid_game_cursor_variation_enter()
     */
     ...
     * @brief Tree editing operations: appending moves, adding/promoting/deleting variations, and
     * truncation.
     * @{
     */
     ...
     *
     * @param[in,out] game            Pointer to the game to mutate. Must not be NULL.
     * @param[in]     cursor          Pointer to the cursor indicating the insertion node. Must not
     * be NULL.
     * @param[in]     move            Move specification to execute and record.
     * @param[out]    out_next_cursor Pointer to a handle pointer receiving the newly allocated
     * cursor positioned after the added move. Must not be NULL.
     *
     * @retval SCID_OK                 Move appended successfully.
     * @retval SCID_ERROR_BAD_ARG      If any argument is NULL, cursor is not at line end, or move
     * is invalid.
     ...
     *
     * @param[in,out] game                 Pointer to the game to mutate. Must not be NULL.
     * @param[in]     cursor               Pointer to the cursor at the branch point. Must not be
     * NULL.
     * @param[in]     initial_comment      Optional comment attached to the start of the variation
     * (may be NULL).
     * @param[out]    out_added            Pointer receiving non-zero (`1`) if variation was
     * created; `0` otherwise. Must not be NULL.
     * @param[out]    out_variation_cursor Pointer to a handle pointer receiving a newly allocated
     * cursor at the start of the new variation on success. Must not be NULL.
     *
     * @retval SCID_OK           Variation created successfully.
     * @retval SCID_ERROR_BAD_ARG If @p game, @p cursor, @p out_added, or @p out_variation_cursor is
     * NULL, or if cursor is at the end of the line.
     *
     * @note The caller acquires ownership of @p out_variation_cursor and must release it with @ref
     * scid_game_cursor_free().
     *
     ...
     *
     * @param[in,out] game      Pointer to the game to mutate. Must not be NULL.
     * @param[in]     cursor    Pointer to the cursor situated immediately after the target move.
     * Must not be NULL.
     * @param[in]     nag       NAG code to attach (1..255).
     * @param[out]    out_added Pointer receiving non-zero (`1`) if NAG added; `0` if already
     * present. Must not be NULL.
     *
     * @retval SCID_OK           NAG added successfully.
     * @retval SCID_ERROR_BAD_ARG If @p game, @p cursor, or @p out_added is NULL, or cursor is at
     * line start.
     *
     ...
     * @param[in]     cursor      Pointer to the cursor situated immediately after the target move.
     * Must not be NULL.
     * @param[in]     is_move_nag Non-zero (`1`) to remove move assessment NAGs (1..6); zero (`0`)
     * for positional NAGs.
     * @param[out]    out_removed Pointer receiving non-zero (`1`) if a NAG was removed; `0`
     * otherwise. Must not be NULL.
     *
     * @retval SCID_OK           Removal processed successfully.
     * @retval SCID_ERROR_BAD_ARG If @p game, @p cursor, or @p out_removed is NULL, or cursor is at
     * line start.
     *
     ...
     *
     * @param[in,out] game   Pointer to the game to mutate. Must not be NULL.
     * @param[in]     cursor Pointer to the cursor situated immediately after the target move. Must
     * not be NULL.
     *
    ...
    /**
     * @brief Promotes the current sub-variation to become the first (primary) variation at its
     * fork.
     *
     * @param[in,out] game                Pointer to the game to mutate. Must not be NULL.
     * @param[in]     cursor              Pointer to the cursor in the variation to promote. Must
     * not be NULL.
     * @param[out]    out_promoted        Pointer receiving non-zero (`1`) if promoted; `0` if
     * already first or mainline. Must not be NULL.
     * @param[out]    out_promoted_cursor Pointer to a handle pointer receiving a newly allocated
     * cursor at the equivalent position in the promoted variation on success. Must not be NULL.
     *
     * @retval SCID_OK           Promotion completed successfully.
     * @retval SCID_ERROR_BAD_ARG If any argument is NULL.
     *
     * @note The caller acquires ownership of @p out_promoted_cursor and must release it with @ref
     * scid_game_cursor_free().
     *
    ...
    /**
     * @brief Promotes the current sub-variation all the way up to become the new mainline of the
     * game.
     *
     ...
     * not be NULL.
     * @param[out]    out_promoted        Pointer receiving non-zero (`1`) if promoted; `0` if
     * already on mainline. Must not be NULL.
     * @param[out]    out_mainline_cursor Pointer to a handle pointer receiving a newly allocated
     * cursor at the equivalent position in the new mainline on success. Must not be NULL.
     *
     * @retval SCID_OK           Promotion completed successfully.
     * @retval SCID_ERROR_BAD_ARG If any argument is NULL.
     *
     * @note The caller acquires ownership of @p out_mainline_cursor and must release it with @ref
     * scid_game_cursor_free().
     *
     ...
     *
     * @param[in,out] game              Pointer to the game to mutate. Must not be NULL.
     * @param[in]     cursor            Pointer to the cursor inside the variation to delete. Must
     * not be NULL.
     * @param[out]    out_deleted       Pointer receiving non-zero (`1`) if deleted; `0` if on
     * mainline. Must not be NULL.
     * @param[out]    out_parent_cursor Pointer to a handle pointer receiving a newly allocated
     * cursor positioned at the parent fork node on success. Must not be NULL.
     *
     ...
     *
     * @param[in,out] game       Pointer to the game to mutate. Must not be NULL.
     * @param[in]     cursor     Pointer to the cursor indicating the truncation point. Must not be
     * NULL.
     * @param[out]    out_cursor Pointer to a handle pointer receiving a newly allocated cursor at
     * the new terminal position. Must not be NULL.
     *
    ...
    /**
     * @brief Truncates the beginning of the current line by removing all moves preceding the cursor
     * position.
     *
     * Sets the starting position of the line or game to the board state at the cursor.
     *
     * @param[in,out] game       Pointer to the game to mutate. Must not be NULL.
     * @param[in]     cursor     Pointer to the cursor indicating the new start node. Must not be
     * NULL.
     * @param[out]    out_cursor Pointer to a handle pointer receiving a newly allocated cursor at
     * the new start position. Must not be NULL.
     *
     * @retval SCID_OK           Truncation completed successfully.
     * @retval SCID_ERROR_BAD_ARG If any argument is NULL.
     *
