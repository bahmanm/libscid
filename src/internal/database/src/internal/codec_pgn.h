...
namespace scid::database
{
    ...
    class CodecPgn final : public CodecProxy<CodecPgn>
    {
        ...
        public:
            ...
            flush() final
            {
                scid::core::errorT errFile =
                    (file_.pubsync() == 0) ? scid::core::OK : scid::core::ERROR_FileWrite;
                ...
                std::size_t scidFlagsOutLen)
            {
                    ...
                    scidFlags && scidFlagsOut && scidFlagsOutLen > 0)
                {
                    ...
                    std::copy_n(
                        scidFlags->data(), std::min(scidFlagsOutLen - 1, scidFlags->size()),
                        scidFlagsOut);
