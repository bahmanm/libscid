...
namespace scid::database
{
        ...
        scid::core::Position const& pos)
    {
        ...
        if ((board_[scid::core::E1] == scid::core::WK ||
             board_[scid::core::G1] == scid::core::WK) &&
    ...
    void
    SearchPos::disableOptStoredLine()
    {
        storedLine_ = nullptr;
    }
        ...
        const IndexEntry& ie) const
    {
        ...
        if (less_mat(
                materialSig_, ie.GetFinalMatSig(), ie.GetPromotionsFlag(), ie.GetUnderPromoFlag()))
        {
            return -2;
        }
        return -1;
