...
namespace scid::core
{
    ...
    class Game
    {
        public:
             ...
             */
            std::string&
            findOrCreateTag(std::string_view tag);
             ...
             */
            const std::string*
            findExtraTag(std::string_view tag) const;
             ...
             */
            void
            removeExtraTag(std::string_view tag);
             ...
             */
            scid::core::errorT
            setStartFen(const char* fen);

            /**
             * Sets the non-standard start position from an already validated position.
             */
            void
            setStartPosition(const scid::core::Position& position);
             ...
             */
            Move&
            appendMainlineMove(MoveSpec spec);

            /**
             * Sets the comment before the first mainline move.
             */
            void
            setInitialComment(std::string_view value);
