...
namespace scid::core
{
    ...
    std::size_t
    Game::mainlineHalfMoveCount() const
    {
    ...
    void
    Game::setEvent(std::string_view value)
    {
    ...
    void
    Game::setSite(std::string_view value)
    {
    ...
    void
    Game::setRound(std::string_view value)
    {
    ...
    void
    Game::setWhiteName(std::string_view value)
    {
    ...
    void
    Game::setBlackName(std::string_view value)
    {
    ...
    void
    Game::setWhiteRating(Rating value)
    {
    ...
    void
    Game::setBlackRating(Rating value)
    {
    ...
    void
    Game::setDate(scid::core::dateT value)
    {
    ...
    void
    Game::setEventDate(scid::core::dateT value)
    {
    ...
    void
    Game::setResult(scid::core::resultT value)
    {
    ...
    void
    Game::setEco(std::string_view value)
    {
    ...
    std::string*
    Game::findStandardTag(std::string_view tag)
    {
        if (tag.size() == 5)
        {
            if (tag == "Event")
    ...
    std::string&
    Game::findOrCreateTag(std::string_view tag)
    {
        if (auto standard = findStandardTag(tag))
            return *standard;

        auto it = std::find_if(header_.tags.begin(), header_.tags.end(), [&](auto const& entry) {
    ...
    const std::vector<TagPair>&
    Game::extraTags() const
    {
        return header_.tags;
    }
    ...
    const std::string*
    Game::findExtraTag(std::string_view tag) const
    {
    ...
    void
    Game::removeExtraTag(std::string_view tag)
    {
        header_.tags.erase(
            std::remove_if(
                header_.tags.begin(), header_.tags.end(),
    ...
    bool
    Game::hasNonStandardStart() const
    {
    ...
    const scid::core::Position*
    Game::startPosition() const
    {
        return startPosition_ ? &*startPosition_ : nullptr;
    }
    ...
    scid::core::errorT
    Game::setStartFen(const char* fen)
    {
    ...
    void
    Game::setStartPosition(const scid::core::Position& position)
    {
    ...
    Variation&
    Move::addVariation(std::string_view initialComment)
    {
    ...
    Move&
    MoveSequence::appendMove(MoveSpec spec)
    {
    ...
    Move&
    Game::appendMainlineMove(MoveSpec spec)
    {
    ...
    void
    Game::setInitialComment(std::string_view value)
    {
