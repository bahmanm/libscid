...
namespace
{
    ...
    TEST(
        CoreGameCursorTest,
        MovesNextAndPreviousThroughMainline)
    {
        scid::core::Game game;
    ...
    TEST(
        CoreGameCursorTest,
        ReturnsCurrentPositionAtMainlineLocation)
    {
        scid::core::Game game;
        game.appendMainlineMove(quiet(scid::core::E2, scid::core::E4));
        game.appendMainlineMove(quiet(scid::core::E7, scid::core::E5));
        ...
        EXPECT_STREQ("rnbqkbnr/pppp1ppp/8/4p3/4P3/8/PPPP1PPP/RNBQKBNR w KQkq - 0 2", fen);
    }
        ...
        SeeksToMainlinePly)
    {
        scid::core::Game game;
        game.appendMainlineMove(quiet(scid::core::E2, scid::core::E4));
        auto& second = game.appendMainlineMove(quiet(scid::core::E7, scid::core::E5));
        ...
        EntersAndExitsVariationFromNextMove)
    {
        ...
        EXPECT_EQ("Queen pawn alternative", cursor.currentVariation()->initialComment);
        EXPECT_EQ(1U, cursor.variationDepth());
        EXPECT_EQ(0U, cursor.variationIndex());
        EXPECT_TRUE(cursor.isAtLineStart());
        EXPECT_TRUE(cursor.isAtVariationStart());
        ...
        SavesAndRestoresVariationLocation)
    {
        ...
        variationMoves.push_back({quiet(scid::core::C2, scid::core::C4), "c4", {}, {}});
        variationMoves.push_back({quiet(scid::core::E7, scid::core::E5), "e5", {}, {}});
