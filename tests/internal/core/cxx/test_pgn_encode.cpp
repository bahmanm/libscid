...
TEST(
    Test_PgnEncodeCore,
    BreakLinesWithRuntimeWidth)
{
    using namespace std::literals;

    auto text = std::string("1. e4\0"sv) + std::string("e5\0"sv) + std::string("2. Nf3\0"sv) +
                std::string("Nc6"sv);
    ...
    EncodeCoreGame)
{
    ...
    auto& first = game.appendMainlineMove({scid::core::D2, scid::core::D4, scid::core::EMPTY});
    ...
    childVariation.line.appendMove({scid::core::E2, scid::core::E4, scid::core::EMPTY});
    childVariation.line.appendMove({scid::core::E7, scid::core::E5, scid::core::EMPTY});
    game.appendMainlineMove({scid::core::D7, scid::core::D5, scid::core::EMPTY});
    game.appendMainlineMove({scid::core::C2, scid::core::C4, scid::core::EMPTY});
...
TEST(
    Test_PgnEncodeCore,
    EncodeCoreGameWithLineBreaking)
{
    using namespace std::literals;
    ...
    game.appendMainlineMove({scid::core::E7, scid::core::E5, scid::core::EMPTY});
...
TEST(
    Test_PgnEncodeCore,
    EncodeCoreGameWithRuntimeLineWidth)
{
    using namespace std::literals;
    ...
    std::string pgn;
    scid::core::pgn::encode(game, pgn, scid::core::pgn::EncodeOptions{.lineWidth = 20});
...
TEST(
    Test_PgnEncodeCore,
    EncodeCoreGameWithSymbolicNags)
{
    using namespace std::literals;

    scid::core::Game game;
    auto& first = game.appendMainlineMove({scid::core::E2, scid::core::E4, scid::core::EMPTY});
    first.metadata.nags.push_back(scid::core::Nag::GoodMove);
    first.metadata.nags.push_back(scid::core::Nag::Diagram);

    std::string pgn;
    scid::core::pgn::encode_game(game, pgn, scid::core::pgn::EncodeOptions{.symbolicNags = true});
...
TEST(
    Test_PgnEncodeCore,
    EncodeCoreGameWithContentSelection)
{
    using namespace std::literals;
