...
namespace
{
    ...
    TEST(
        AttacksTest,
        KnightAttacksFromCentre)
    {
        expectAttackList(knightAttacks[E4], std::array{D2, F2, C3, G3, C5, G5, D6, F6});
    }

    TEST(
        AttacksTest,
        KingAttacksFromCorner)
    {
    ...
    TEST(
        AttacksTest,
        KingAttacksFromCentre)
    {
        expectAttackList(kingAttacks[E4], std::array{D3, E3, F3, D4, F4, D5, E5, F5});
    }

    TEST(
        AttacksTest,
        SentinelSquaresHaveNoAttacks)
    {
