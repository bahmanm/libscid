...
TEST(
    Test_PositionMoveSpec,
    ParsesAppliesAndFormatsSan)
{
    ...
    EXPECT_STREQ(fen, "rnbqkbnr/pp1ppppp/8/2p5/4P3/8/PPPP1PPP/RNBQKBNR w KQkq - 0 2");
}

TEST(
    Test_PositionMoveSpec,
    ParsesCoordinateCastlingAndPromotion)
{
    {
        scid::core::Position pos;
        ASSERT_EQ(scid::core::OK, pos.ReadFromFEN("r3k2r/8/8/8/8/8/8/R3K2R w KQkq - 0 1"));
        scid::core::MoveSpec spec;
        ASSERT_EQ(scid::core::OK, pos.readCoordinateMoveSpec(spec, "e1g1", false));
    ...
    {
        scid::core::Position pos;
        ASSERT_EQ(scid::core::OK, pos.ReadFromFEN("k7/6P1/8/8/8/8/8/7K w - - 0 1"));
        scid::core::MoveSpec spec;
        ASSERT_EQ(scid::core::OK, pos.readCoordinateMoveSpec(spec, "g7g8q", false));
...
{
    scid::core::Position pos;
    EXPECT_EQ(scid::core::OK, pos.ReadFromFEN("rnb1k2Q/1p5p/p7/4p3/4q3/8/PPP2R1P/2K5 b"));
    EXPECT_NE(scid::core::OK, pos.ReadFromFEN("rnb1k2/Q1p5p/p7/4p3/4q3/8/PPP2R1P/2K5 b"));
    EXPECT_NE(scid::core::OK, pos.ReadFromFEN("rnb1k2Q/1p5p/p7/4a3/4q3/8/PPP2R1P/2K5 b"));
    EXPECT_NE(scid::core::OK, pos.ReadFromFEN("rnb1k2Q/1p5p/p7/4p3/4q3/8/PKP2R1P/2K5 b"));
    EXPECT_NE(scid::core::OK, pos.ReadFromFEN("rnb1k2Q/1p5p/p7/4p3/4q3/8/PPP2R1P/2K5 a"));
    EXPECT_NE(
        scid::core::OK,
        pos.ReadFromFEN("rnbqkbn1/ppppppppr/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1"));
}
...
TEST(
    Test_PositionIsLegalMove,
    CoversCastlingCheckAndEnPassant)
{
    {
        scid::core::Position pos;
        ASSERT_EQ(scid::core::OK, pos.ReadFromFEN("8/8/8/8/8/8/6k1/4K2R w K -"));
        EXPECT_FALSE(pos.IsLegalMove(scid::core::E1, scid::core::G1, scid::core::EMPTY));
    }
    {
        scid::core::Position pos;
        ASSERT_EQ(scid::core::OK, pos.ReadFromFEN("8/2B5/8/8/4pP2/8/7k/3K4 b - f3 0 1"));
        EXPECT_FALSE(pos.IsLegalMove(scid::core::E4, scid::core::F3, scid::core::EMPTY));
    }
    {
        scid::core::Position pos = scid::core::Position::getStdStart();
        EXPECT_TRUE(pos.IsLegalMove(scid::core::B1, scid::core::C3, scid::core::EMPTY));
        EXPECT_FALSE(pos.IsLegalMove(scid::core::E3, scid::core::E4, scid::core::EMPTY));
    }
}

TEST(
    Test_PrintFen,
    NormalizesIllegalCastlingFlags)
{
