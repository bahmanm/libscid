...
namespace
{
    ...
    expect_roundtrip(std::string_view pgn)
    {
        ...
        for (;;)
        {
            EXPECT_EQ(currentFen(original, originalLocation), currentFen(decoded, decodedLocation));
            EXPECT_EQ(
                scid::core::notation::nextSan(original, originalLocation),
                scid::core::notation::nextSan(decoded, decodedLocation));
            ...
            const auto originalErr =
                originalCursor.next() ? scid::core::OK : scid::core::ERROR_EndOfMoveList;
            const auto decodedErr =
                decodedCursor.next() ? scid::core::OK : scid::core::ERROR_EndOfMoveList;
...
TEST(
    Test_DecodeMove,
    representative_encoded_moves_roundtrip)
{
    expect_roundtrip(
        "1.e4 e5 2.Nf3 Nc6 3.Bb5 a6 4.Ba4 Nf6 5.O-O Be7 6.Re1 b5 "
        "7.Bb3 d6 8.c3 O-O 9.h3");
    expect_roundtrip("1.d4 d5 2.Qd3 Nf6 3.Qb5+ c6 4.Qa4");
    expect_roundtrip(
